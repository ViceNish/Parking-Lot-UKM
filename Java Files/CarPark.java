...
public class CarPark{
	...
	//constructor
	public CarPark(String name,String namep,String idd,String paus, String job,String car, String tmpt, String p) {
		this.name=name;
		this.namep=namep;
		this.idd=idd;
		this.paus=paus;
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(l=="Lot 1") {
							try {
								...
								//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Carpark\\Lot 1\\exist.txt");
								FileWriter x=new FileWriter("C:\\savefile\\Parking\\FTSM\\Carpark\\Lot 1\\parked.txt");
								//FileWriter y=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\Parking List\\parked.txt");
						...
						try {
							...
							//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Carpark\\Lot 2\\exist.txt");
						...
						try {
							...
							//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Carpark\\Lot 3\\parked.txt");
						...
						try {
							...
							//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Carpark\\Lot 4\\parked.txt");
						...
						try {
							...
							//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Carpark\\Lot 5\\exist.txt");
	...
	//new Edit(name,namep,idd,paus,job, car, tmpt,p)
	}
