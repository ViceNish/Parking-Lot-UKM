...
public class StaffParkingm{

	private JFrame frame=new JFrame("Staff Parking");
	...
	//constructor
	public StaffParkingm(String name,String namep,String idd,String paus, String job,String motor, String tmpt, String p) {
		this.name=name;
		this.namep=namep;
		this.idd=idd;
		this.paus=paus;
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(l=="S_Lot 1") {
							try {
								...
								//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Staffpark\\S_Lot 1\\exist.txt");
						...
						try {
							...
							//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Staffpark\\S_Lot 2\\exist.txt");
						...
						try {
							...
							//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Staffpark\\S_Lot 3\\exist.txt");
						...
						try {
							...
							//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Staffpark\\S_Lot 4\\exist.txt");
						...
						try {
							...
							//FileWriter exi=new FileWriter("C:\\Users\\ADMIN1\\Desktop\\t1\\Assignment\\savefile\\Parking\\FTSM\\Staffpark\\S_Lot 5\\exist.txt");
